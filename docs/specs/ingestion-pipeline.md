...
## Data Flow
`raw corpus -> custom scan/parse -> optional AutoGen findings -> LLM schema extraction -> custom validation + concept alias normalization -> preview/apply JSON -> audit record -> Neo4j graph load`
